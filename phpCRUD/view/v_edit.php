            ...
            <div class="card-body p-5">
              ...
              <form action="../controller/post.php?id=<?php echo $_GET['id']?>" method="post">
                ...
                <div class="d-flex justify-content-center">
                  <!--  button named 'update' that submits the form to post.php -->
                <button type="submit" name="update" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Register</button>
